CREATE TABLE news (
    ...
    who_summary VARCHAR(255) COMMENT '누가',
    what_summary VARCHAR(255) COMMENT '무엇을',
    when_summary VARCHAR(255) COMMENT '언제',
    why_summary VARCHAR(255) COMMENT '왜',
    where_summary VARCHAR(255) COMMENT '어디서',
    how_summary VARCHAR(255) COMMENT '어떻게',
    summary VARCHAR(255) COMMENT '요약 내용',
